...
---
[![GoDoc](https://godoc.org/github.com/heilkit/tg?status.svg)](https://godoc.org/github.com/heilkit/tg)
...
```bash
go get -u github.com/heilkit/tg
```
...
[here](https://godoc.org/github.com/heilkit/tg#pkg-constants).
...
```go
import "github.com/heilkit/tg/middleware"
```
...
[here](https://pkg.go.dev/github.com/heilkit/tg#Option).
